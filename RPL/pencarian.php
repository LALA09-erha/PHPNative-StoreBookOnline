                                        ...
                                        <li class="hm-minicart">
                                            ...
                                            <div class="minicart">
                                                <ul class="minicart-product-list">
                                                    <li>
                                                        <a href="detail.php?id=<?php echo $value['id_produk']; ?>" class="minicart-product-image">
                                                            <img src="img/product/small-size/5.jpg" alt="cart products">
                                                        </a>
                                                        <div class="minicart-product-details">
                                                            <h6><a href="detail.php?id=<?php echo $value['id_produk']; ?>">Aenean eu tristique</a></h6>
                                                            <span>£40 x 1</span>
                                                        </div>
                                                    ...
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="detail.php?id=<?php echo $value['id_produk']; ?>">
                                                                <img src="foto_produk/<?php echo $value['foto_produk']; ?>" alt="Li's Product Image">
                                                            </a>
                                                        ...
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="detail.php?id=<?php echo $value['id_produk']; ?>"><?php echo $value['nama_produk']; ?></a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price">Rp. <?php echo number_format($value['harga_produk']); ?></span>
                                                            ...
                                                            <div class="add-actions">
                                                                <ul class="add-actions-link">
                                                                    <?php if($value['stok_produk']>=1) : { ?>
                                                                    <li class="add-cart active"><a href="beli.php?id=<?php echo $value['id_produk']; ?>">Add to cart</a></li>
                                                                    <?php  } ?>
                                                                    <?php else  :{ ?>
                                                ...
                                                <div class="row product-layout-list">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="shop-add-action mb-xs-30">
                                                            <ul class="add-actions-link">
                                                                <?php if($value['stok_produk']>=1) : { ?>
                                                                <li class="add-cart"><a href="beli.php?id=<?php echo $value['id_produk']; ?>">Add to cart</a></li>
                                                                <?php  } ?>
                                                                <?php else  :{ ?>
