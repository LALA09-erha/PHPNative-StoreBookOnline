                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="li-product-number">
                                                <span><?php echo $pecah['tanggal_pembelian']; ?></span>
                                            </td>

                                            <td class="product-subtotal"><span class="amount">Rp.
                                                    <?php echo number_format($pecah['total_pembelian']);  ?></span></td>
                                            <td class="li-product-number">
                                                <span><?php echo  $pecah['status_pembelian']; ?><br>
                                            ...
                                            <td class="li-product-add-cart">
                                                <a href="nota.php?id=<?php echo $pecah['id_pembelian'] ?>"
                                                    class="bg-info p-1">Nota</a>
                                                <?php if ($pecah['status_pembelian'] == 'Tertunda' || $pecah['status_pembelian'] == 'Batal (Jumlah Duit Tidak Sesuai)') : ?>
                                                <a href="pembayaran.php?id=<?php echo $pecah['id_pembelian'] ?>"
                                                    class="bg-success p-1">Pembayaran</a>
                                                <?php endif ?>
                                                <?php
                                                    if ($pecah['status_pembelian'] == 'Selesai(Barang Sudah Sampai)') : ?>
                                                <a href="nota.php?id=<?php echo $pecah['id_pembelian'] ?>"
                                                    class="bg-warning p-1">Beri Nilai</a>
                                                <?php endif ?>
