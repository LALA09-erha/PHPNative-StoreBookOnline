                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-subtotal"><span class="amount">Rp.
                                                    <?php echo number_format($pecah['harga_produk'] * $pecah['jumlah']); ?></span>
                                            </td>
                                            <td class="li-product-remove"><a
                                                    href="hapuskeranjang.php?id_produk=<?php echo $pecah['id_produk'] ?>"
                                ...
                                <div class="col-12">
                                    <div class="coupon-all">
                                        <div class="cart-page-total">
                                            ...
                                            <a href="hapuskeranjang.php?id=<?php echo $id_pelanggan; ?>"
                            ...
                            <div class="row">
                                <div class="col-md-5 ml-auto">
                                    <div class="cart-page-total">
                                        ...
                                        <a href="bayar.php">Proceed to checkout</a>
                                    </div>
                                </div>
                            </div>
                        </form>
